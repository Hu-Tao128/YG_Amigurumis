...
<section id="ordenar-por-box">
    ...
    <?php
        ...
        $query = "SELECT COUNT(IDAmigurumi) FROM amigurumis INNER JOIN categorias on amigurumis.IDCategoria=categorias.IDCategoria WHERE amigurumis.Estado='DISPONIBLE' and categorias.Estado='DISPONIBLE' and amigurumis.Producto='Accesorio' ";
    ...
    <?php
        ...
        <div class="ordenar-select-opts" >
            <a href="<?=ROOTURL?>?accion=accesorios&orderby=amigurumis.IDAmigurumi&order=desc&option=mas-relevantes" >
                <div class="ordenar-select-opts-btns" >M&aacute;s relevantes</div>
            </a>
            <a href="<?=ROOTURL?>?accion=accesorios&orderby=amigurumis.NombreAmigurumi&order=asc&option=nombres" >
                <div class="ordenar-select-opts-btns" >Nombre</div>
            </a>
            <a href="<?=ROOTURL?>?accion=accesorios&orderby=amigurumis.Precio&order=desc&option=mayor-precio" >
                <div class="ordenar-select-opts-btns" >Mayor Precio</div>
            </a>
            <a href="<?=ROOTURL?>?accion=accesorios&orderby=amigurumis.Precio&order=asc&option=menor-precio" >
...
<section class="productos-todos">
    <?php
        require_once 'funciones-cliente.php';
        $listAccesorios = obtenerAccesorios();
        if($listAccesorios!=null)
        {	
            foreach($listAccesorios as $campo) {
