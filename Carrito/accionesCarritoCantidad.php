...
if(isset($_SESSION['cliente_session'])){
    ...
    if($accion=='uno-mas-Carrito'){
        $query = "UPDATE carrito SET Cantidad=Cantidad+1 WHERE IDUsuario='$IDUsuario' and IDAmigurumi='$IDAmigurumi'; ";
    }elseif($accion=='uno-menos-Carrito'){
        $query = "UPDATE carrito SET Cantidad=Cantidad-1 WHERE IDUsuario='$IDUsuario' and IDAmigurumi='$IDAmigurumi'; ";;
    }else{
        echo "";
    }
